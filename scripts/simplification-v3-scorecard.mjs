...
export const V3_HOTSPOTS = [
  ...
  },
  {
    ...
    file: "src/main/agent-runtime/agentRuntime.ts",
    ...
    validationCommand:
      "pnpm exec vitest run src/main/agent-runtime/agentRuntimeStreamState.test.ts src/main/agent-runtime/tools/agentRuntimeToolTranscript.test.ts src/main/agent-runtime/agentRuntimeMessageContent.test.ts",
    firstParityCommand:
      "pnpm exec vitest run src/main/agent-runtime/agentRuntimeStreamState.test.ts src/main/agent-runtime/tools/agentRuntimeToolTranscript.test.ts src/main/agent-runtime/agentRuntimeMessageContent.test.ts",
  ...
  },
  {
    ...
    file: "src/main/projectStore/projectStore.ts",
    ...
    validationDomain: "project-board",
    validationCommand: "pnpm exec vitest run src/main/projectStore/projectStore.test.ts src/main/projectStore/projectStoreSchema.test.ts",
    firstParityCommand: "pnpm exec vitest run src/main/projectStore/projectStore.test.ts src/main/projectStore/projectStoreSchema.test.ts",
