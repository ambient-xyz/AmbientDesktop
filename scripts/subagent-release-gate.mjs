...
const files = {
  ...
  agentRuntimeTest: await readText("src/main/agent-runtime/agentRuntime.test.ts"),
  ...
  projectStoreSubagentFoundationTest: await readText("src/main/projectStore/projectStoreSubagentFoundation.test.ts"),
