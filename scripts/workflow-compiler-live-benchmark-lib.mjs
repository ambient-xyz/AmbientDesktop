  ...
  return [
    {
      ...
      command: "pnpm",
      args: ["exec", "vitest", "run", "src/main/workflow/workflowPiTransport.live.test.ts", "--reporter=dot"],
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "compiles a browser QA workflow with live Ambient"],
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "dogfoods graph-first review"],
      env: { AMBIENT_WORKFLOW_LIVE: "1" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 540_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "canonical Scottsdale weekend activities workflow"],
      env: { AMBIENT_WORKFLOW_LIVE: "1" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 540_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "local Downloads classification workflow with live Ambient"],
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "local Downloads image categorization workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "document render PDF workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "browser user intervention pause and resume"],
      env: { AMBIENT_WORKFLOW_LIVE: "1" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "real managed-browser intervention and reveal"],
      env: { AMBIENT_WORKFLOW_LIVE: "1" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "external-site managed-browser"],
      env: { AMBIENT_WORKFLOW_LIVE: "1" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Calendar upcoming-events brief workflow through the real Google wrapper"],
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Drive file-evidence report workflow through the real Google wrapper"],
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Gmail last-100-emails categorization workflow through the real Google wrapper"],
      env: {
    ...
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Gmail 300-message pagination workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Gmail 300-message chunked categorization workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Gmail 1000-message metadata-first categorization workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Google Drive and Calendar transcript pagination workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Google meeting transcript action-item extraction workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "tree model-reduce workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "browser_search pagination collection workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "movie-night current-data recommendation workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "Scottsdale 100-source PDF workflow with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
    {
      ...
      command: "bash",
      args: ["scripts/test-node-native.sh", "src/main/workflow/workflowDogfood.test.ts", "-t", "long-field connector workflow through long_context_process with live Ambient"],
      env: { AMBIENT_WORKFLOW_LIVE: "1", AMBIENT_WORKFLOW_LIVE_TIMEOUT_MS: "900000" },
      exclusiveGroup: "native-workflow-vitest",
      timeoutMs: 900_000,
    },
