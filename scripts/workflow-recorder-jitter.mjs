...
const tasks = [
  commandTask({
    ...
    args: [
      ...
      "src/main/workflowRecorderReleaseGate.test.ts",
      "src/main/ambientWorkflows.test.ts",
      "src/main/workflowRecorder.test.ts",
    ],
  }),
  commandTask({
  ...
  commandTask({
    ...
    args: [
      ...
      "src/main/ambientToolRouter.test.ts",
      "src/main/plannerMode.test.ts",
    ],
  }),
  planSanityTask(),
];
...
function liveGmiSmokeTask() {
  return commandTask({
    ...
    tier: "live",
    command: "bash",
    args: ["scripts/test-node-native.sh", "src/main/workflowRecorderLiveSmoke.test.ts"],
    env: {
