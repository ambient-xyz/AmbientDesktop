...
const report = buildMcpDefaultRuntimeReleaseGateReport({
  ...
  sourceFiles: {
    mcpInstallGateTs: await readText("src/main/mcp/mcpInstallGate.ts"),
    agentRuntimeTs: await readText("src/main/agent-runtime/agentRuntime.ts"),
    agentRuntimeMcpServerToolsTs: await readText("src/main/agent-runtime/mcp/agentRuntimeMcpServerTools.ts"),
    mcpServerPiToolsTs: await readText("src/main/mcp/mcpServerPiTools.ts"),
    mcpServerPiToolSupportTs: await readText("src/main/mcp/mcpServerPiToolSupport.ts"),
    mcpServerInstallPiToolTs: await readText("src/main/mcp/mcpServerInstallPiTool.ts"),
    mcpStandardImportPiToolsTs: await readText("src/main/mcp/mcpStandardImportPiTools.ts"),
    mcpRemoteProxyPiToolsTs: await readText("src/main/mcp/mcpRemoteProxyPiTools.ts"),
    mcpServerPiToolsTestTs: await readText("src/main/mcp/mcpServerPiTools.test.ts"),
    containerRuntimeProbeServiceTs: await readText("src/main/container-runtime/containerRuntimeProbeService.ts"),
    containerRuntimeInstallLauncherTs: await readText("src/main/container-runtime/containerRuntimeInstallLauncher.ts"),
    mcpDefaultCapabilityInstallerTs: await readText("src/main/mcp/mcpDefaultCapabilityInstaller.ts"),
    ociImageResolverTs: await readText("src/main/container-runtime/ociImageResolver.ts"),
    toolHiveRuntimeServiceTs: await readText("src/main/tool-runtime/toolHiveRuntimeService.ts"),
