...
export const V2_HOTSPOTS = [
  ...
  },
  {
    ...
    validationDomain: "general",
    validationCommand: "pnpm exec vitest run src/main/agent-runtime/agentRuntimeStreamState.test.ts src/main/agent-runtime/tools/agentRuntimeToolTranscript.test.ts src/main/agent-runtime/agentRuntimeMessageContent.test.ts",
