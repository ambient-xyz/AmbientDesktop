...
function repoInput() {
  return {
    ...
    sourceFiles: {
      mcpInstallGateTs: readFileSync(join(process.cwd(), "src/main/mcpInstallGate.ts"), "utf8"),
      agentRuntimeTs: readFileSync(join(process.cwd(), "src/main/agentRuntime.ts"), "utf8"),
      agentRuntimeMcpServerToolsTs: readFileSync(join(process.cwd(), "src/main/agentRuntimeMcpServerTools.ts"), "utf8"),
      mcpServerPiToolsTs: readFileSync(join(process.cwd(), "src/main/mcpServerPiTools.ts"), "utf8"),
      mcpServerPiToolsTestTs: readFileSync(join(process.cwd(), "src/main/mcpServerPiTools.test.ts"), "utf8"),
      containerRuntimeProbeServiceTs: readFileSync(join(process.cwd(), "src/main/containerRuntimeProbeService.ts"), "utf8"),
      containerRuntimeInstallLauncherTs: readFileSync(join(process.cwd(), "src/main/containerRuntimeInstallLauncher.ts"), "utf8"),
      mcpDefaultCapabilityInstallerTs: readFileSync(join(process.cwd(), "src/main/mcpDefaultCapabilityInstaller.ts"), "utf8"),
      ociImageResolverTs: readFileSync(join(process.cwd(), "src/main/ociImageResolver.ts"), "utf8"),
      toolHiveRuntimeServiceTs: readFileSync(join(process.cwd(), "src/main/toolHiveRuntimeService.ts"), "utf8"),
      rendererAppTsx: [
