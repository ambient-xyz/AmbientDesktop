...
function repoInput() {
  return {
    ...
    sourceFiles: {
      ...
      mcpServerPiToolSupportTs: readFileSync(join(process.cwd(), "src/main/mcp/mcpServerPiToolSupport.ts"), "utf8"),
      mcpServerInstallPiToolTs: readFileSync(join(process.cwd(), "src/main/mcp/mcpServerInstallPiTool.ts"), "utf8"),
      mcpStandardImportPiToolsTs: readFileSync(join(process.cwd(), "src/main/mcp/mcpStandardImportPiTools.ts"), "utf8"),
      mcpRemoteProxyPiToolsTs: readFileSync(join(process.cwd(), "src/main/mcp/mcpRemoteProxyPiTools.ts"), "utf8"),
