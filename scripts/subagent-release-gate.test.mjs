...
describe("sub-agent release gate", () => {
  ...
  it("fails when the deterministic release suite omits core contract tests", () => {
    ...
    input.packageJson.scripts["test:subagents:deterministic"] = input.packageJson.scripts["test:subagents:deterministic"].replace(
      "src/main/subagentHardening.test.ts ",
      "",
    );
    ...
    expect(report.status).toBe("attention");
    expect(report.releaseDecision.blockingIssues).toEqual(expect.arrayContaining([
      "Deterministic sub-agent suite is missing src/main/subagentHardening.test.ts.",
    ]));
  });
...
function packageJson() {
  return {
    scripts: {
      ...
      "test:callable-workflow-dogfood:proof": "AMBIENT_CALLABLE_WORKFLOW_DOGFOOD_EVIDENCE_OUT=test-results/callable-workflow-dogfood/latest.json pnpm exec vitest run src/main/callableWorkflowDogfoodEvidence.test.ts -t \"builds mutating child workflow dogfood evidence with restart repair proof\"",
      "test:callable-workflow-rehydration:proof": "AMBIENT_CALLABLE_WORKFLOW_REHYDRATION_EVIDENCE_OUT=test-results/callable-workflow-rehydration/latest.json pnpm exec vitest run src/main/callableWorkflowRehydrationEvidence.test.ts -t \"builds restart rehydration evidence for linked task artifacts, runs, progress, and usage\"",
      "test:subagents:lifecycle-edges:proof": "AMBIENT_SUBAGENT_LIFECYCLE_EDGE_EVIDENCE_OUT=test-results/subagent-lifecycle-edges/latest.json pnpm exec vitest run src/main/subagentLifecycleEdgeEvidence.test.ts -t \"builds lifecycle edge evidence for restart, stop, detach, cancel, retry, timeout, and partial results\"",
      ...
      "test:subagents:live": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_SUBAGENT_LIVE=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentPiToolLiveSmoke.live.test.ts",
      "test:subagents:live:smoke": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_SUBAGENT_LIVE=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentPiToolLiveSmoke.live.test.ts -t \"lets live Pi spawn a visible child thread with runtime events\"",
      ...
      "test:subagents:live:long-context-authority": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_SUBAGENT_LIVE=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentPiToolLiveSmoke.live.test.ts -t \"lets a live child use long_context_process only on granted document roots\"",
      "test:subagents:live:approval-authority": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_SUBAGENT_LIVE=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentPiToolLiveSmoke.live.test.ts -t \"surfaces live child file authority approval requests to the parent\"",
      "test:subagents:live:browser-approval": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_SUBAGENT_LIVE=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentPiToolLiveSmoke.live.test.ts -t \"surfaces live child browser authority approval requests to the parent\"",
      ...
      "test:subagents:scenario-dogfood": "AMBIENT_PROVIDER=${AMBIENT_PROVIDER:-ambient} AMBIENT_LIVE_MODEL=${AMBIENT_LIVE_MODEL:-moonshotai/kimi-k2.7-code} AMBIENT_SUBAGENT_SCENARIO_DOGFOOD=1 node scripts/run-live-node-test.mjs -- vitest run src/main/subagentScenarioDogfood.live.test.ts",
...
function deterministicSubagentTestScript() {
  return [
    ...
    "src/main/callableWorkflowRegistry.test.ts",
    "src/main/projectStoreSymphonyWorkflowRecipe.test.ts",
    "src/main/callableWorkflowPiTools.test.ts",
    "src/main/callableWorkflowExecutionPlan.test.ts",
    "src/main/callableWorkflowTaskQueue.test.ts",
    "src/main/callableWorkflowRunner.test.ts",
    "src/main/callableWorkflowDogfoodEvidence.test.ts",
    "src/main/callableWorkflowRehydrationEvidence.test.ts",
    ...
    "src/main/callableWorkflowParentBlocking.test.ts",
    "src/main/agentRuntimeFinalizationBlocking.test.ts",
    "src/main/workflowAgentRuntime.test.ts",
    "src/main/modelRuntimeRegistry.test.ts",
    "src/main/modelProviderCapabilityProbe.test.ts",
    "src/main/modelProviderCapabilityProbeRunner.test.ts",
    "src/main/modelProviderEndpointProbeAdapter.test.ts",
    "src/main/modelProviderEndpointProbeService.test.ts",
    "src/main/modelProviderCredentialStore.test.ts",
    "src/main/modelProviderSettingsInstall.test.ts",
    "src/main/subagentHardening.test.ts",
    "src/main/subagentInvariants.test.ts",
    "src/main/subagentObservability.test.ts",
    "src/main/subagentIdempotency.test.ts",
    "src/main/piChildSessionAdapter.test.ts",
    "src/main/piEventMapper.test.ts",
    "src/main/subagentRuntimeEventPersistence.test.ts",
    "src/main/subagentContextFilter.test.ts",
    "src/main/subagentPromptRuntime.test.ts",
    "src/main/subagentStructuredOutput.test.ts",
    "src/main/subagentCompletionGuard.test.ts",
    "src/main/subagentStartupReconciliation.test.ts",
    "src/main/subagentLifecycleParentMailbox.test.ts",
    "src/main/subagentRepair.test.ts",
    "src/main/subagentRetention.test.ts",
    "src/main/subagentLifecycleHooks.test.ts",
    "src/main/subagentApprovalBridge.test.ts",
    "src/main/subagentSupervisorRequest.test.ts",
    "src/main/subagentApprovalDecision.test.ts",
    "src/main/ipc/registerSubagentIpc.test.ts",
    "src/main/ipc/registerSettingsIpc.test.ts",
    "src/main/subagentReviewedMaturityEvidence.test.ts",
    "src/main/subagentLiveSmokeEvidence.test.ts",
    "src/main/chatExport.test.ts",
    "src/main/subagentLiveHistoryEvidence.test.ts",
    "src/main/subagentDesktopDogfoodEvidence.test.ts",
    "src/main/subagentLiveConfidenceEvidence.test.ts",
    "src/main/subagentLiveConfidenceMaturityEvidence.test.ts",
    "src/main/subagentMaturity.test.ts",
    "src/main/subagentThreatModel.test.ts",
    "src/main/projectStoreSubagentFoundation.test.ts",
    "src/main/subagentPiTools.test.ts",
    "src/main/subagentPiToolInput.test.ts",
    "src/main/subagentPiToolResult.test.ts",
    "src/main/subagentSpawnPreRunPlanner.test.ts",
    "src/main/subagentSpawnPreflightResolver.test.ts",
    "src/main/subagentChildWorktreePreparer.test.ts",
    "src/main/subagentTargetResolver.test.ts",
    "src/main/subagentToolScopeRequest.test.ts",
    "src/main/subagentToolScopeLaunchPolicy.test.ts",
    "src/main/subagentSpawnBlockDecision.test.ts",
    "src/main/subagentPreRunSpawnFailureRecorder.test.ts",
    "src/main/subagentPostReservationSpawnFailureRecorder.test.ts",
    "src/main/subagentLaunchRejectionRecorder.test.ts",
    "src/main/subagentSpawnLaunchExecutor.test.ts",
    "src/main/subagentFailedSpawnWaitBarrier.test.ts",
    "src/main/subagentResultValidation.test.ts",
    "src/main/subagentWaitBarrierResolution.test.ts",
    "src/main/subagentWaitContextResolver.test.ts",
    "src/main/subagentWaitAgentExecutor.test.ts",
    "src/main/subagentTurnBudgetWrapUpRecorder.test.ts",
    "src/main/subagentWaitCompletionRecorder.test.ts",
    "src/main/subagentWaitBarrierAttentionRecorder.test.ts",
    "src/main/subagentSpawnFailure.test.ts",
    "src/main/subagentSpawnRequest.test.ts",
    "src/main/subagentMailbox.test.ts",
    "src/main/subagentMailboxRequest.test.ts",
    "src/main/subagentChildMailboxExecutor.test.ts",
    "src/main/subagentAgentStatus.test.ts",
    "src/main/subagentChildActiveTools.test.ts",
    "src/main/subagentToolScopeSnapshot.test.ts",
    "src/main/subagentGroupJoin.test.ts",
    "src/main/subagentGroupedCompletionRecorder.test.ts",
    "src/main/subagentParentPolicyResolution.test.ts",
    "src/main/subagentWaitBarrierEvaluation.test.ts",
    "src/main/subagentWaitMailbox.test.ts",
    "src/main/subagentBarrierDecision.test.ts",
    "src/main/subagentBarrierDecisionRecorder.test.ts",
    "src/main/subagentBarrierControl.test.ts",
    "src/main/subagentBarrierControlExecutor.test.ts",
    "src/main/subagentBarrierDecisionExecutor.test.ts",
    "src/main/subagentCancelAgent.test.ts",
    "src/main/subagentCancelAgentExecutor.test.ts",
    "src/main/subagentCloseAgent.test.ts",
    "src/main/subagentCloseAgentExecutor.test.ts",
    "src/main/subagentBatchJobs.test.ts",
    "src/main/localTextDelegation.test.ts",
    "src/main/localTextSubagentRuntime.test.ts",
    "src/main/localModelRuntimeManager.test.ts",
    "src/main/localRuntimeInventory.test.ts",
    "src/main/localModelRuntimeStatus.test.ts",
    "src/main/localModelRuntimeStart.test.ts",
    "src/main/localModelRuntimeStop.test.ts",
    "src/main/localModelRuntimeRestart.test.ts",
    "src/main/agentRuntimeLocalRuntimeTools.test.ts",
    "src/main/localModelResourceRegistry.test.ts",
    "src/main/localTextSubagentStartupConfig.test.ts",
...
function files() {
  return {
    ...
    subagentLiveHistoryEvidenceTest: "records clean required-live release-gate history rows as live dogfood maturity evidence records failed maturity evidence when required-live history skips lanes or has advisories src/main/subagentLiveHistoryEvidence.test.ts",
    ...
    subagentDesktopDogfoodEvidenceTest: "records passed Desktop dogfood artifacts as maturity evidence with a history entry records failed Desktop dogfood maturity evidence with actionable issues src/main/subagentDesktopDogfoodEvidence.test.ts",
  ...
  return {
    ...
    run: {
      ...
      command: electron
        ...
        : ["node", "scripts/run-live-node-test.mjs", "--", "vitest", "run", "src/main/subagentPiToolLiveSmoke.live.test.ts"],
      branch: "main",
