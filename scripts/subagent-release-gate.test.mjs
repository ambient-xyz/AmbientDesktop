...
function files() {
  return {
    ...
    symphonyMutationWorkspaceLeaseService: "acquireSymphonyMutationWorkspaceLease scratch_overlay readOnlyBaseRoots writableRoots releaseSymphonyMutationWorkspaceLease heartbeatSymphonyMutationWorkspaceLease",
    symphonyMutationWorkspaceLeaseServiceTest: "sym-scratch-overlay-isolation creates a scratch_overlay lease and leaves root files untouched before promotion",
    subagentChildDecisionRequest: "buildSymphonyChildDecisionRequest retry_child grant_scope accept_partial cancel_group exit_symphony needs_attention captcha",
    ...
    symphonyWorkflowRecipesTest: "sym-pattern-six-pack defines all six planned Symphony patterns behind ambient.subagents requires conversational Custom choices and metric or rubric templates for every pattern keeps launch cards, callable workflow tools, and recorder policy aligned with the plan",
    ...
    agentRuntimeSymphonyParentMode: "activeToolNamesForSymphonyParentMode directExecutionPolicy deny_substantive_tools expectedWorkflowToolName ambient_workflow_symphony_map_reduce shouldRejectSymphonyParentModeActiveRunHandoff",
    agentRuntimeSymphonyParentModeTest: "sym-parent-not-worker keeps only conductor tools and strips parent-worker tools after recovery activation read bash edit write browser_search web_research_search",
    symphonyWebCapabilityRouter: "buildSymphonyWebCapabilityRoutePlan planSymphonyWebResearchProviderOrder dynamicHeadlessBrowser interactiveBrowserApproved childToolScopeAllowsInteractiveBrowserFallback",
    symphonyWebCapabilityRouterTest: "sym-web-capability-routing: prefers Brave search, fetches static before dynamic, and blocks child browser fallback ambient-brave-search dynamicHeadlessBrowser interactiveBrowser",
    ...
    subagentChildTranscriptComponentTest: "sym-live-ux-export renders a live child transcript shell with runtime event context subagent-parent-cluster-child-transcript-live completionSummaryDeferredWhileLive child transcript message stream is the primary live surface desktop_chat_export_child_bundle",
    subagentChildTranscriptUiModel: "subagentChildTranscriptState subagentChildTranscriptRuntimeEventRows subagentChildTranscriptMailboxEventRows",
    subagentChildTranscriptUiModelTest: "keeps running child transcripts live without a terminal summary",
    appConversationMessagesTest: "renders live child transcripts from subagent cluster state data-child-transcript-layout=\"transcript-first\" data-child-blocker-panel=\"after-transcript\"",
