  ...
  return [
    ...
    },
    {
      ...
      args: [
        ...
        "src/main/workflowProgramPathRegistry.test.ts",
        "src/main/workflowProgramPathRegistryJitter.test.ts",
        "src/main/workflowProgramOutputContracts.test.ts",
        "src/main/workflowProgramOutputContractJitter.test.ts",
      ],
      exclusiveGroup: "workflow-vitest",
