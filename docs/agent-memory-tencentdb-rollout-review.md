...
6. Run live Ambient/Pi memory-off and memory-on dogfood with the Ambient provider and Kimi selected while GLM 5.1 is degraded, recording recall/capture transcript evidence and context accounting.
