...
6. Run live Ambient/Pi memory-off and memory-on dogfood with the Ambient provider and Kimi selected while Use an available supported provider for live validation, recording recall/capture transcript evidence and context accounting.
