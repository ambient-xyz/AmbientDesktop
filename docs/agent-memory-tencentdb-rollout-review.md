...
6. Run live Ambient/Pi memory-off and memory-on dogfood with the Ambient provider and Kimi selected while The currently selected provider may be degraded, recording recall/capture transcript evidence and context accounting.
