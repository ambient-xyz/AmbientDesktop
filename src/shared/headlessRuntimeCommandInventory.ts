...
export function buildHeadlessRuntimeUxCommands(settingsCatalog: RuntimeUxSettingDescriptor[]): RuntimeUxCommandDescriptor[] {
  return [
    ...buildSettingsCommands(settingsCatalog),
    ...buildProjectCommands(),
    ...buildWorkflowCommands(),
    ...buildChatCommands(),
    ...buildApprovalCommands(),
    ...buildMessagingCommands(),
    ...buildStatusCommands(),
  ];
}

function buildSettingsCommands(settingsCatalog: RuntimeUxSettingDescriptor[]): RuntimeUxCommandDescriptor[] {
...
function buildProjectCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
      id: "project.list",
      label: "List projects",
...
function buildWorkflowCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
      id: "workflow.list",
...
function buildChatCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
      id: "chat.list",
      label: "List chats",
...
function buildApprovalCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
      id: "approval.list",
...
function buildMessagingCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
...
function buildStatusCommands(): RuntimeUxCommandDescriptor[] {
  return [
    {
      id: "runtime.status",
