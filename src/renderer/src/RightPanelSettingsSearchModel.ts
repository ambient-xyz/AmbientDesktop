  ...
  return [
    ...
    },
    {
      ...
      terms: [
        ...
        state.settings.memory.mode === "enabled_all" ? "enabled globally" : undefined,
        state.settings.memory.mode === "per_thread" ? "available per thread" : undefined,
        state.settings.memory.mode === "disabled" ? "disabled" : undefined,
    ...
    },
    {
      ...
      terms: [
        ...
        "tool execution",
        "first message only",
        "hide after first assistant reply",
        state.settings.thinkingDisplay.hideRunStatusCardAfterFirstMessage ? "first message only" : "always shown",
      ],
    },
