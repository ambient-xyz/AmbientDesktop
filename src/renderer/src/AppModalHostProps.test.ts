...
function baseInput(input: Partial<AppModalHostPropsInput> = {}): AppModalHostPropsInput {
  ...
  return {
    ...
    onApiKeyChange: noop,
    onCancelGoalBudget: noop,
    onCommandPaletteQueryChange: noop,
    onConfirmGoalBudget: noop,
    onGoalBudgetChange: noop,
...
function appInputFromBase(base: AppModalHostPropsInput): AppModalHostPropsForAppInput {
  return {
    ...
    actions: {
      ...
      goalBudgetActions: {
        onCancelGoalBudget: base.onCancelGoalBudget,
        onConfirmGoalBudget: base.onConfirmGoalBudget,
        onGoalBudgetChange: base.onGoalBudgetChange,
      },
      permissionActions: {
    ...
    workflowRuntimeState: {
      goalBudgetDialog: base.goalBudgetDialog,
