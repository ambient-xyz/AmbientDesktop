...
import type { AmbientPermissionGrant, CreateAmbientPermissionGrantInput, PermissionRequest } from "../../shared/types";
import {
...
describe("permission grants", () => {
  ...
  it("limits sensitive grants to thread-level scopes by default", () => {
    const secret = enrichPermissionRequest(request({ risk: "secret-path", detail: "/path/to/user/.ssh/id_rsa" }), baseContext);
