...
import type { MiniCpmVisionAnalysisCommandSummary, MiniCpmVisionAnalysisResult, MiniCpmVisionAnalyzeInput, MiniCpmVisionCleanupResult, MiniCpmVisionImageInputReference, MiniCpmVisionImageSummary, MiniCpmVisionObservation, MiniCpmVisionRuntimeCandidate, MiniCpmVisionRuntimeContract, MiniCpmVisionRuntimeInstallResult, MiniCpmVisionRuntimeMacosSecurity, MiniCpmVisionRuntimePreflightCheck, MiniCpmVisionRuntimeReleaseArtifact, MiniCpmVisionRuntimeReleaseManifest, MiniCpmVisionRuntimeReleaseManifestVerification, MiniCpmVisionRuntimeState, MiniCpmVisionSetupInput, MiniCpmVisionSetupResult, MiniCpmVisionTask, MiniCpmVisionValidationMetadata, MiniCpmVisionVideoInputReference, MiniCpmVisionVideoSummary } from "../../shared/localRuntimeTypes";
