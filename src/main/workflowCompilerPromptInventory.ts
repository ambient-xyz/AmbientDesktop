...
const staticPromptRuleInventory: WorkflowCompilerPromptRule[] = [
  inventoryRule({
    ...
    duplicatedIn: ["src/main/workflowCompilerService.test.ts"],
  ...
  inventoryRule({
    ...
    duplicatedIn: ["src/shared/workflowProgramIr.ts", "src/main/workflowProgramTypecheck.ts"],
    validatorRefs: ["parseWorkflowProgramIr", "validateWorkflowProgramStatic"],
    migrationBlockers: [],
  }),
  inventoryRule({
  ...
  inventoryRule({
    ...
    duplicatedIn: ["src/main/workflowProgramLowering.ts", "src/main/workflowProgramCodegen.ts"],
  ...
  inventoryRule({
    ...
    duplicatedIn: ["src/main/workflowCompiler.test.ts"],
  ...
  inventoryRule({
    ...
    duplicatedIn: ["src/main/workflowProgramCompiler.test.ts", "src/main/workflowCompilerPlanCoverage.test.ts"],
  ...
  inventoryRule({
    ...
    duplicatedIn: ["src/main/workflowCompiler.test.ts", "src/main/workflowCompilerService.test.ts"],
...
const retiredPolicyPromptRuleDefinitions: WorkflowCompilerPromptRuleDefinition[] = [
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowCompiler.test.ts", "src/main/workflowProgramTypecheck.ts"],
    validatorRefs: [
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowProgramTypecheck.ts"],
    validatorRefs: [
      "google_workspace_call.workflowGuidance",
      "google_workspace_search_methods.workflowGuidance",
      "validateWorkflowProgramStatic",
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowProgramCompiler.test.ts"],
    validatorRefs: [
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowCompilerPlanCoverage.test.ts"],
    validatorRefs: [
      "workflowCompilerRecipes:current_web_research",
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowProgramCompiler.test.ts", "src/main/workflowDogfood.test.ts"],
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/workflowProgramCompiler.test.ts", "src/main/workflowCompiler.test.ts"],
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/desktopToolRegistry.ts", "src/main/workflowProgramCapabilityResolver.ts"],
  ...
  policyRule({
    ...
    duplicatedIn: ["src/main/desktopToolRegistry.ts", "src/main/workflowCompilerRecipes.ts", "src/main/workflowCompilerAbstractionRegression.test.ts"],
