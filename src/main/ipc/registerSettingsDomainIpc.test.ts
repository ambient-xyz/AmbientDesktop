...
function createSettingsServices(): SettingsDomainServices {
  return {
    ...
    disableAgentMemoryStarter: vi.fn(async () => ({} as any)),
    enableAgentMemoryStarter: vi.fn(async () => ({} as any)),
    getAgentMemoryDiagnostics: vi.fn(async () => ({} as any)),
    getAgentMemoryStarterStatus: vi.fn(async () => ({} as any)),
    ...
    repairAgentMemoryStarter: vi.fn(async () => ({} as any)),
