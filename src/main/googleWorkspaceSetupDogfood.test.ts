...
import type { AgentRuntime, AgentRuntimeGoogleWorkspaceTools } from "./agentRuntime";
...
interface RuntimeModules {
  AgentRuntime: typeof import("./agentRuntime").AgentRuntime;
  BrowserCredentialStore: typeof import("./browserCredentialStore").BrowserCredentialStore;
  BrowserService: typeof import("./browserService").BrowserService;
  ProjectStore: typeof import("./projectStore").ProjectStore;
}
