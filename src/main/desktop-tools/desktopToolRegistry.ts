...
export const bashToolDescriptor: DesktopToolDescriptor = {
  ...
  promptGuidelines: [
    ...
    "When reporting user-facing absolute local files such as Downloads, Desktop, or Documents results, format them as Markdown file links with file:// URLs, for example [Keynote Presentation(2).pptx](file://<local-user>/Downloads/Keynote%20Presentation(2).pptx), so Ambient Desktop can preview or open them.",
