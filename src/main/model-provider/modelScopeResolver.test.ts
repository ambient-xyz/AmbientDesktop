        ...
        expect.objectContaining({
          ...
          capabilityDiagnostics: expect.arrayContaining([
            expect.objectContaining({
              capability: "context_window",
              status: "pass",
              actual: `${defaultProfile.contextWindowTokens} tokens`,
            }),
            expect.objectContaining({
              capability: "output_budget",
              status: "pass",
              actual: `${defaultProfile.maxOutputTokens} tokens`,
            }),
            expect.objectContaining({
              capability: "tool_use",
              status: "pass",
        ...
        expect.objectContaining({
          ...
          capabilityDiagnostics: expect.arrayContaining([
            ...
            expect.objectContaining({
              capability: "tool_use",
              status: "fail",
              required: "role default tool scope requires model tool use: workspace.read, browser.read, browser.interactive, long-context.read, connector.read",
              actual: "toolUse=none",
            }),
            expect.objectContaining({
              capability: "structured_output",
