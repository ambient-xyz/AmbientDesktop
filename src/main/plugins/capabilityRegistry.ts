...
import { ambientCliCapabilityId, ambientCliRegistryPluginId } from "./pluginsAmbientCliFacade";
import { firstPartyDesktopToolDescriptors, type DesktopToolDescriptor } from "./pluginsDesktopToolFacade";
