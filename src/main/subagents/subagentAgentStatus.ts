...
export function compactSubagentRunForPi(run: SubagentRunSummary): Record<string, unknown> {
  return {
    ...
    ...(run.symphonyMutationWorkspaceLease ? {
      mutationWorkspaceLease: {
        leaseId: run.symphonyMutationWorkspaceLease.leaseId,
        kind: run.symphonyMutationWorkspaceLease.kind,
        status: run.symphonyMutationWorkspaceLease.status,
        rootPath: run.symphonyMutationWorkspaceLease.rootPath,
        declaredWritableRoots: run.symphonyMutationWorkspaceLease.declaredWritableRoots,
        writableRoots: run.symphonyMutationWorkspaceLease.writableRoots,
        acquiredAt: run.symphonyMutationWorkspaceLease.acquiredAt,
        lastHeartbeatAt: run.symphonyMutationWorkspaceLease.lastHeartbeatAt,
      },
    } : {}),
