...
export const SUBAGENT_DELEGATED_TOOL_AUTHORITY_SURFACES: readonly SubagentDelegatedToolAuthoritySurface[] = [
  {
    ...
    proofTests: [
      ...
      "src/main/pi/piReadOperations.test.ts",
  ...
  },
  {
    ...
    proofTests: [
      ...
      "src/main/agent-runtime/agentRuntimeGitTools.test.ts",
    ],
  ...
  },
  {
    ...
    proofTests: [
      "src/main/agent-runtime/agentRuntimeFileAuthority.test.ts",
      "src/main/pi/piReadOperations.test.ts",
      "src/main/agent-runtime/tools/agentRuntimeToolRunnerFileTools.test.ts",
    ],
  ...
  },
  {
    ...
    proofTests: [
      "src/main/agent-runtime/tools/agentRuntimeToolRunnerTools.test.ts",
      "src/main/agent-runtime/agentRuntime.test.ts",
    ],
  ...
  },
  {
    ...
    proofTests: [
      "src/main/subagents/subagentChildActiveTools.test.ts",
      "src/main/subagents/subagentDelegatedToolAuthority.test.ts",
    ],
    notes: "Browser read remains a policy vocabulary category, but direct browser-backed tools are not active for child sessions from this category. Use connector.read for ordinary web research or browser.interactive for explicit browser authority.",
  },
  {
    schemaVersion: SUBAGENT_DELEGATED_TOOL_AUTHORITY_AUDIT_SCHEMA_VERSION,
    ...
    proofTests: [
      "src/main/subagents/subagentBrowserAuthority.test.ts",
  ...
  },
  {
    ...
    proofTests: [
      "src/main/subagents/subagentChildActiveTools.test.ts",
      "src/main/plugins/runtime-tools/agentRuntimePluginMcpTools.test.ts",
    ],
  ...
  },
  {
    ...
    proofTests: [
      "src/main/agent-runtime/agentRuntime.test.ts",
      "src/main/mini-cpm/miniCpmVisionProvider.test.ts",
      "src/main/permissions/permissionPolicy.test.ts",
    ],
