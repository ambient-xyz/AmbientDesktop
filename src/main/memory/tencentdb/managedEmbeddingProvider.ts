...
const modelRepo = "ggml-org/embeddinggemma-300m-qat-q8_0-GGUF";
const modelRevision = "66f974f8cd48cc3b9c41c516b95508e75b4bee64";
const modelFilename = "embeddinggemma-300m-qat-Q8_0.gguf";
const modelRoot = ".ambient/memory/tencentdb/embeddings/models";
const serverStateRoot = ".ambient/memory/tencentdb/embeddings/llama-server";
const modelSha256 = "6fa0c02a9c302be6f977521d399b4de3a46310a4f2621ee0063747881b673f67";
const modelXetHash = "4920b629844676a28f95d4815d795ba4c7cd5846ed68501e0764bc5fa48491ab";
const modelSizeBytes = 328_577_056;
const estimatedResidentMemoryBytes = 768 * 1024 * 1024;
