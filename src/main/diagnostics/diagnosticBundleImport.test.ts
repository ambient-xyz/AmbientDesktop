...
describe("diagnostic bundle import", () => {
  ...
  it("imports bounded Tencent memory diagnostics without raw memory payloads", () => {
    ...
    expect(JSON.stringify(result)).not.toContain("do not return raw starter log");
  });
...
function agentMemoryStarterSummary(): AgentMemoryStarterStatus {
  return {
    schemaVersion: "ambient-agent-memory-starter-status-v1",
    checkedAt: "2026-06-13T00:00:00.000Z",
