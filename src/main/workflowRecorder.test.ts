    ...
    const messages: ChatMessage[] = [
      {
        ...
        content: [
          ...
          "Credential file was /path/to/ambient-hardening/snapshots/shared-secrets/example/userData/credentials.json",
        ].join("\n"),
        createdAt: "2026-05-19T16:00:01.000Z",
        metadata: {
          ...
          status: "done",
          artifactPath: "/path/to/ambient-hardening/snapshots/shared-secrets/example/tool-output.txt",
        },
      },
    ];
