...
describe("Pi extension sandbox packages", () => {
  ...
  itLivePiSandbox("installs pi-arxiv from a Pi catalog URL and runs a sandboxed tool", async () => {
  ...
  itLivePiSandbox("classifies pi-ffmpeg catalog package as not sandbox-installable", async () => {
