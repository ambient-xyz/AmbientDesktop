...
describeNative("welcome onboarding", () => {
  ...
  it("does not duplicate seeded chats on later startup", async () => {
    ...
    try {
      ...
      const first = ensureWelcomeOnboardingProject({ userDataPath: root, projectRegistry: registry });
      const second = ensureWelcomeOnboardingProject({ userDataPath: root, projectRegistry: registry });
  ...
  it("archives old product-owned seeded pages while preserving user-created Welcome chats", async () => {
    ...
    try {
      ...
      ensureWelcomeOnboardingProject({ userDataPath: root, projectRegistry: registry });
